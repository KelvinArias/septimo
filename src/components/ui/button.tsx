...
const buttonStyles: Record<ButtonVariant, string> = {
  ...
  secondary:
    "border border-[#d8d4cc] bg-white text-[#5f5a52] hover:border-[#aaa398] inline-flex min-h-11 items-center justify-center rounded-md px-4 text-sm font-medium transition lg:min-h-9",
  ghost:
